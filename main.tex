% !TeX document-id = {eec29a31-687d-4eb8-90e6-1d4a075542cb}
%%
...
\BITSetup{
  ...
  info = {
    ...
    % 如需要换行，则用 “\\” 符号分割。
    title = 非全维位置量测条件下的无人机编队控制方法研究,
    titleEn = {Cooperative Formation Control of UAV Swarms with Partial State Measurements},
    school = 空天科学与技术学院,
    major = 航空宇航科学与技术,
    class = 01062201,
    author = 罗嘉豪,
    studentId = 1120221698,
    supervisor = 何绍溟,
